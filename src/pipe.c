...
void execute_pipe(struct dynamicArray *commands) {
    ...
    if (right_pid == 0) {
        ...
        //JE VEUX DORMIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIRRRRRRRRRRRRR
        //TOP 7 DES RAPPEURS : NUMERO 7 FAVEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
        //PRRRRR PRRRRR PATAPIM
...
int handle_pipes(struct dynamicArray *tokens, char *cwd) {
    ...
    if (pipe_index == -1) return 0; // Early exit if no pipe
